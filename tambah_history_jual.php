	...
	<div class="wrapper">
		...
		<div class="con">
			<div class="login">
					...
					<div class="kotaklogb">
						<table border="0">
							<form action="proses_tambah_history_jual.php" method="post">
							<tr>
							...
							<tr>
								...
								<td align="right">
									<input type="text" name="barang" placeholder="karung" size="20">
								</td>
							</tr>
							<tr>
								<td align="left" align="center">Total Penjualan</td>
								<td align="right">
									<input type="text" name="total" placeholder="karung" size="20">
								</td>
							</tr>
							</form>
						</table>
