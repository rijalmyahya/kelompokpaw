...
$total = $jumlah*$harga;
	...
	if(empty($id) || empty($nama) || empty($harga)  || empty($jumlah) || empty($tanggal)){
		...
		mysql_query("insert into barangmasuk(tanggal_keluar,id_barang,nama_barang,jumlah_barang,harga_barang,total_harga)
		values('$tanggal','$id','$nama','$jumlah','$harga','total_harga')") or die(mysql_error());
